      ...
      <div class="profile-layout">
        ...
        <aside class="profile-card">
          ...
          <div class="contact-item">
            ...
            <div class="contact-icon" style="background: #FFF7ED; color: #C2410C; display: flex; align-items: center; justify-content: center;">
            ...
            <div>
              ...
              <strong>
                {{ member.umur ? member.umur + ' Tahun' : '-' }} {{ member.kategoriUmur ? '(' + member.kategoriUmur + ')' : '' }}
              </strong>
