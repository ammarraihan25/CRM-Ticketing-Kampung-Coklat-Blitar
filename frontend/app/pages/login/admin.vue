  ...
  <div class="login-role-page">
    ...
    <section class="role-hero">
      ...
      <div class="hero-content">
        ...
        <h1 class="hero-title">
          Portal <strong>Super Admin</strong>
        </h1>
      ...
      <div class="form-container">
        <div class="login-card-split">
          ...
          <div class="card-left-info">
            ...
            <h2 class="info-title">Autentikasi Super Admin</h2>
            <p class="info-desc">
              Masukkan kredensial akun administrator Anda untuk mengakses dashboard kontrol utama Kampung Coklat.
            </p>

            <!-- Quick Autofill Button -->
            <div class="autofill-box">
              <button type="button" class="btn-autofill" @click="fillAdminCredentials">
                <span class="bolt-icon">⚡</span>
                <span>Auto-fill Akun Demo Admin</span>
              </button>
            </div>
          </div>
          ...
          <div class="card-right-form">
            <div class="form-header">
              ...
              <p class="form-subtitle">Lengkapi email dan kata sandi admin</p>
            </div>

            <form class="clean-auth-form" @submit.prevent="handleLogin">
              <!-- Field 1: Email Address -->
              <div class="form-group">
                <label for="admin-email" class="field-label">Alamat Email Super Admin</label>
              ...
              <div class="remember-row">
                <label class="checkbox-label">
                  ...
                  <span class="checkbox-text">Ingat sesi Super Admin di perangkat ini</span>
                </label>
              </div>
...
const alertHelp = () => {
  alert('[BANTUAN AKSES SUPER ADMIN]\nEmail Demo: admin@kampungcoklat.id\nSandi Demo: admin123\n\nHubungi IT Operations jika akun Anda terkunci.')
}
</script>
