      ...
      <div class="form-container">
        <div class="login-card-split">
          ...
          <div class="card-left-article">
            ...
            <h2 class="article-title">Kendali Penuh Sistem CRM & Operasional</h2>
            <p class="article-content">Selamat datang di pusat kendali utama. Sebagai Super Admin, Anda memiliki otoritas tertinggi untuk mengatur seluruh konfigurasi sistem Kampung Coklat.</p>
          ...
          <div class="card-right-form">
            <div class="form-header-unified">
              ...
              <p class="info-desc">Masukkan kredensial akun Super Admin Anda</p>
            </div>
            ...
            <form class="clean-auth-form" @submit.prevent="handleLogin">
              <div class="form-group">
                ...
                <div class="input-wrap">
                  ...
                  <input id="admin-email" v-model="email" type="email" class="field-input" placeholder="admin@kampungcoklat.id" required />
                </div>
              </div>
