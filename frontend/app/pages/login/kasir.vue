      ...
      <div class="form-container">
        <div class="login-card-split">
          ...
          <div class="card-left-info">
            ...
            <h2 class="info-title">Autentikasi Kasir POS</h2>
            <p class="info-desc">
              Masukkan kredensial akun kasir Anda untuk membuka sesi loket dan melayani penjualan tiket POS Kampung Coklat.
            </p>

            <!-- Quick Autofill Button -->
            <div class="autofill-box">
              <button type="button" class="btn-autofill" @click="fillKasirCredentials">
                <span class="bolt-icon">⚡</span>
                <span>Auto-fill Akun Demo Kasir</span>
              </button>
            </div>
          </div>
          ...
          <div class="card-right-form">
            <div class="form-header">
              ...
              <p class="form-subtitle">Lengkapi email dan kata sandi kasir</p>
            </div>

            <form class="clean-auth-form" @submit.prevent="handleLogin">
              <!-- Field 1: Email Address -->
              <div class="form-group">
                <label for="kasir-email" class="field-label">Alamat Email Kasir</label>
                <div class="input-wrap">
                  ...
                  <input
                    ...
                    type="email"
                    class="field-input"
                    placeholder="kasir@kampungcoklat.id"
                    required
                  />
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="label-row">
                  <label for="kasir-password" class="field-label">Kata Sandi</label>
              ...
              <div class="remember-row">
                <label class="checkbox-label">
                  ...
                  <span class="checkbox-text">Ingat sesi Kasir di perangkat ini</span>
                </label>
              </div>

              <!-- Submit Button -->
              <button type="submit" class="btn-submit-primary" :disabled="isLoading">
                <span v-if="!isLoading">Buka Sesi Kasir POS &rarr;</span>
...
const fillKasirCredentials = () => {
  email.value = 'kasir@kampungcoklat.id'
...
const alertHelp = () => {
  alert('[BANTUAN AKSES KASIR POS]\nEmail Demo: kasir@kampungcoklat.id\nSandi Demo: kasir123\n\nHubungi Supervisor FO jika terminal terkunci.')
}
</script>
...
.card-left-info {
  background: linear-gradient(135deg, #FAF7F2 0%, #F6ECE0 100%);
