      ...
      <div class="form-container">
        <div class="login-card-split">
          ...
          <div class="card-left-article">
            ...
            <h2 class="article-title">Pelayanan Cepat & Transaksi Terintegrasi</h2>
            <p class="article-content">Portal point-of-sale modern untuk memproses tiket masuk, wahana, dan paket edukasi dengan cepat dan akurat demi kepuasan pengunjung.</p>
          ...
          <div class="card-right-form">
            <div class="form-header-unified">
              ...
              <h2 class="info-title">Portal Kasir Front Office</h2>
              <p class="info-desc">Masukkan kredensial akun Kasir Front Office Anda</p>
            </div>
            ...
            <form class="clean-auth-form" @submit.prevent="handleLogin">
              <div class="form-group">
                ...
                <div class="input-wrap">
                  ...
                  <input id="admin-email" v-model="email" type="email" class="field-input" placeholder="kasir@kampungcoklat.id" required />
                </div>
              </div>
              ...
              <button type="submit" class="btn-submit-primary" :disabled="isLoading">
                <span v-if="!isLoading">Masuk Sebagai Kasir Front Office &rarr;</span>
