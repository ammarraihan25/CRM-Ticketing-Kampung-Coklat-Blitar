  ...
  <div class="guestbook-page">
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <h1>
          <span style="display: block; font-size: clamp(38px, 4.5vw, 60px); margin-bottom: 5px;">Pendaftaran Membership</span>
          <strong>Kampung Coklat</strong>
        </h1>

        <p>
          Bergabunglah dengan program keanggotaan kami untuk menikmati diskon spesial, akses awal ke produk baru, dan penawaran eksklusif khusus anggota.
        </p>
        ...
        <div class="guestbook-card">
          ...
          <template v-if="step === 'form'">
            ...
            <div class="form-heading">
              ...
              <p>
                Daftar sebagai member eksklusif Kampung Coklat
