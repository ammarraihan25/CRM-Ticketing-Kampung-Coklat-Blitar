...
const availableVouchers = ref([
  { code: 'COKLATHEMAT10', name: 'Diskon Spesial Liburan 10%', discount: 10, type: 'percent' },
  { code: 'FAMILYGATHERING', name: 'Potongan Sewa Gedung Rp 100.000', discount: 100000, type: 'fixed' },
  { code: 'CORPBLITAR50', name: 'Voucher Corporate Gathering Rp 50.000', discount: 50000, type: 'fixed' }
])
...
const grandTotal = computed(() => {
  const total = subtotal.value - memberDiscountAmount.value - voucherDiscountAmount.value
...
const processPayment = () => {
  if (!bookingData.value.isMember) {
    addVisitor({
      nama: bookingData.value.namaPemesan || 'Pelanggan Sewa Hall',
  ...
  setTimeout(() => {
    ...
    addPosTransaction({
      ...
      customer: bookingData.value.namaPemesan || bookingData.value.instansi || 'Penyewa Hall'
    })
...
const handlePrintTicket = () => {
  ...
  iframeDoc.write(`
    ...
    <html>
      <head>
        <title>E-Tiket-Venue-${transactionResult.value?.pos_trx_id || 'KC-TIKET'}</title>
...
const finishTransaction = () => {
   cart.value = []
   bookingData.value = { namaPemesan: '', instansi: '', telepon: '', tanggal: new Date().toISOString().split('T')[0], jamMulai: '08:00', jamSelesai: '12:00', isMember: false, memberId: '' }
        ...
        <div class="product-list-wrapper" style="overflow-y: auto; flex: 1; min-height: 0; padding-bottom: 20px; padding-right: 6px;">
          <div class="pos-products-stack">
            <div class="pos-card-full" v-for="product in hallTickets" :key="product.id">
              <div class="pos-thumb-wrap-venue">
      ...
      <div class="payment-modal-container">
        ...
        <div class="pm-modal-top-bar">
          <div class="pm-brand-title">
            ...
            <div>
              <h3 class="pm-main-heading">Pembayaran & Konfirmasi Sewa Hall</h3>
              ...
              <label class="pm-method-card" :class="{'active': paymentMethod === 'cash'}">
                <div class="pm-method-header">
                  <div class="pm-method-info">
                    ...
                    <span class="pm-method-desc">Terima pembayaran tunai langsung dari penyewa / panitia</span>
                  </div>
          ...
          <div class="pm-right-panel">
            <div class="pm-section-header">
              ...
              <div>
                ...
                <p class="pm-panel-subtitle">Rincian venue, diskon member & promo</p>
              </div>
            </div>
            ...
            <div class="pm-trip-card">
              <div class="pm-trip-row">
                ...
                <span class="pm-trip-val">Sewa Tempat & Hall</span>
              </div>
              <div class="pm-trip-row">
                <span class="pm-trip-label">Nama Pemesan / PIC</span>
                <span class="pm-trip-val highlight">{{ bookingData.namaPemesan || '-' }}</span>
              </div>
              <div class="pm-trip-row">
                <span class="pm-trip-label">Instansi / Acara</span>
                <span class="pm-trip-val">{{ bookingData.instansi || 'Pribadi' }}</span>
              </div>
              <div class="pm-trip-row">
                <span class="pm-trip-label">Tanggal Sewa</span>
                <span class="pm-trip-val">{{ bookingData.tanggal || 'Hari Ini' }} ({{ bookingData.jamMulai }} - {{ bookingData.jamSelesai }})</span>
              </div>
            </div>
              ...
              <div v-if="bookingData.isMember" class="pm-member-active-card">
                <div class="pm-member-left">
                  ...
                  <div class="pm-member-info">
                    ...
                    <span class="pm-member-name">{{ bookingData.namaPemesan }}</span>
            ...
            <div class="pm-order-items-box">
              <div class="pm-items-header">Rincian Venue ({{ totalCartQuantity }} Item)</div>
            ...
            <div class="pm-order-footer">
              <div class="pm-total-card">
                <div class="pm-total-info">
                  ...
                  <span class="pm-total-sub">Sudah termasuk PPN & fasilitas gedung</span>
                </div>
    ...
    <div class="ticket-modal-backdrop" v-if="showSuccessModal" @click.self="finishTransaction">
      ...
      <div class="ticket-modal-top-header no-print">
        ...
        <div>
          ...
          <p class="tmt-subtitle">E-Tiket resmi sewa hall telah terbit dan siap digunakan pada hari pelaksanaan</p>
        </div>
      </div>
      ...
      <div class="ticket-pass-card" id="printable-ticket-card">
        ...
        <div class="tpc-main">
          ...
          <div class="tpc-header-bar">
            <div class="tpc-brand">
              ...
              <div>
                ...
                <span class="tpc-brand-tag">SEWA TEMPAT & CONVENTION</span>
              </div>
            </div>
          ...
          <div class="tpc-title-row">
            <div>
              <h2 class="tpc-heading">E-TIKET RESERVASI VENUE</h2>
              <span class="tpc-code-sub">NO. TIKET: <strong>#{{ transactionResult?.pos_trx_id || 'TRX-88291045' }}</strong></span>
            </div>
          ...
          <div class="tpc-grid-card">
            <div class="tpc-meta-col">
              ...
              <span class="tpc-meta-value highlight">{{ bookingData.tanggal || 'Hari Ini' }} ({{ bookingData.jamMulai }} - {{ bookingData.jamSelesai }})</span>
            </div>
            <div class="tpc-meta-col">
              <span class="tpc-meta-label">Instansi / Acara</span>
              <span class="tpc-meta-value">{{ bookingData.instansi || 'Pribadi / Umum' }}</span>
            </div>
            <div class="tpc-meta-col">
              <span class="tpc-meta-label">Perwakilan / PIC</span>
              <span class="tpc-meta-value">{{ bookingData.namaPemesan || 'PIC Acara' }}</span>
            </div>
            <div class="tpc-meta-col">
          ...
          <div class="tpc-items-section">
            <span class="tpc-items-heading">Rincian Venue & Fasilitas ({{ totalCartQuantity }} Unit):</span>
          ...
          <div class="tpc-gate-notice">
            ...
            <span>Tunjukkan e-tiket kepada koordinator lapangan atau petugas operasional venue Kampung Coklat saat serah terima gedung.</span>
          </div>
        </div>
        ...
        <div class="tpc-stub">
          <div class="tpc-stub-header">
            ...
            <span class="tpc-stub-sub">VENUE PASS</span>
          </div>

          <div class="tpc-qr-card">
            <img :src="`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${transactionResult?.pos_trx_id || 'TRX-88291045'}`" alt="QR Code" class="tpc-qr-code" />
          </div>

          <span class="tpc-qr-code-text">{{ transactionResult?.pos_trx_id || 'TRX-88291045' }}</span>
...
.pos-thumb-wrap-venue, .pos-thumb-wrap {
  width: 140px;
  min-width: 140px;
  max-width: 140px;
  height: 115px;
...
.pos-thumb-wrap-venue .pos-thumb-img, .pos-thumb-wrap .pos-thumb-img, .pos-thumb-img {
  width: 100%;
  height: 100%;
  max-width: 100%;
  max-height: 100%;
...
.pos-card-full:hover .pos-thumb-img {
