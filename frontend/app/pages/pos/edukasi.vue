...
const defaultEdukasiTickets = [
  {
    ...
    badge: 'TINGKAT TK / PAUD',
    price: 35000,
    unit: '/ pax',
    highlights: [
      'Menghias Coklat & Pengenalan Kakao',
      'Fun Cooking & Wahana Perahu Ceria',
      'Free Tour Guide & Dokumentasi Kegiatan'
    ],
    desc: 'Program edukasi interaktif untuk merangsang motorik halus dan keceriaan anak usia dini.',
    image: paket_tk
  },
  {
    id: 'paket-sd',
    ...
    unit: '/ pax',
    highlights: [
      'Santripreneur & Industri Coklat',
      'Pembelajaran Mendalam & Ice Breaking',
      'Makan Siang & Tour Guide Lapangan'
    ],
    desc: 'Pengenalan budidaya kakao dan proses produksi coklat yang seru dan edukatif.',
    image: paket_sd
  },
  {
    id: 'paket-smp',
    ...
    unit: '/ pax',
    highlights: [
      'Pasca Panen & Kewirausahaan Kakao',
      'Paket LDKS & Outbound Team Building',
      'Sertifikat Resmi & Makan Siang'
    ],
    desc: 'Edukasi wirausaha, pembentukan karakter kepemimpinan, dan praktek industri.',
    image: paket_smp
  },
  {
    id: 'paket-sma-univ',
    ...
    unit: '/ pax',
    highlights: [
      'Presentasi Riset Kakao & Industri',
      'Praktek Pengolahan Coklat Modern',
      'Sertifikat Keahlian & Fasilitas LDKS'
    ],
    desc: 'Studi komparasi rantai pasok industri coklat dari hulu hingga hilir untuk jenjang lanjut.',
    image: paket_sma
  }
]
    ...
    return filtered.map(t => {
      ...
      return {
        ...
        highlights: match?.highlights || [
          'Akses Masuk & Tour Kebun Kakao',
          'Praktek Menghias Coklat',
          'Free Trainer & Sertifikat'
        ],
...
const checkMemberId = async () => {
  ...
  try {
    ...
    if (member && member.data) {
      ...
      if (member.data.nama) bookingData.value.namaPerwakilan = member.data.nama
...
const availableVouchers = ref([
  { code: 'EDUKASISPEC', name: 'Promo Edukasi Pelajar', type: 'percent', discount: 10, minPax: 1 },
  { code: 'STUDYTOUR', name: 'Potongan Study Tour Rombongan', type: 'fixed', discount: 50000, minPax: 1 },
  { code: 'KAMPUNGCERIA', name: 'Voucher Sekolah Mitra', type: 'percent', discount: 5, minPax: 1 }
])
...
const voucherDiscountAmount = computed(() => {
  ...
  return appliedVoucher.value.discount || 0
})
...
const processPayment = () => {
  if (!bookingData.value.isMember) {
    addVisitor({
      nama: bookingData.value.namaPerwakilan || bookingData.value.instansi || 'Pelanggan Edukasi',
  ...
  addPosTransaction({
    ...
    customer: bookingData.value.instansi || bookingData.value.namaPerwakilan || 'Rombongan Edukasi'
  })
...
const handlePrintTicket = () => {
  ...
  iframeDoc.write(`
    ...
    <html>
      <head>
        <title>E-Tiket-Edukasi-${transactionResult.value?.pos_trx_id || 'KC-TIKET'}</title>
...
const finishTransaction = () => {
   cart.value = []
   bookingData.value = { instansi: '', namaPerwakilan: '', estimasiPeserta: '', telepon: '', tanggal: new Date().toISOString().split('T')[0], isMember: false, memberId: '' }
    ...
    <div class="pos-form-pane">
      ...
      <div class="pos-form-container">
        ...
        <div class="pos-form-group">
          ...
          <input type="text" v-model="bookingData.instansi" placeholder="Contoh: TK Kartika" class="pos-form-input" />
        </div>

        <!-- Nama Perwakilan / Guru -->
        <div class="pos-form-group">
          <label class="pos-form-label">
            <span>Nama Perwakilan / Guru</span>
            <span class="pos-label-req">*</span>
          </label>
          <input type="text" v-model="bookingData.namaPerwakilan" placeholder="Nama Lengkap" class="pos-form-input" />
        </div>
      ...
      <div class="step-2-products" style="display: flex; flex-direction: column; flex: 1; min-height: 0; height: 100%;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
          <h2 class="pane-title" style="margin-bottom: 0; border-bottom: none; padding-bottom: 0;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2c1a13" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 4px;"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
            Pilih Paket: Wisata Edukasi
          </h2>
        ...
        <div class="product-list-wrapper" style="overflow-y: auto; flex: 1; min-height: 0; padding-bottom: 20px; padding-right: 6px;">
          <div class="pos-products-stack">
            <div class="pos-card-full" v-for="product in edukasiTickets" :key="product.id">
              <div class="pos-thumb-wrap-edukasi">
      ...
      <div class="payment-modal-container">
        ...
        <div class="pm-modal-top-bar">
          <div class="pm-brand-title">
            ...
            <div>
              <h3 class="pm-main-heading">Pembayaran & Konfirmasi Edukasi</h3>
              ...
              <label class="pm-method-card" :class="{'active': paymentMethod === 'cash'}">
                <div class="pm-method-header">
                  <div class="pm-method-info">
                    ...
                    <span class="pm-method-desc">Terima pembayaran tunai langsung dari pengunjung / panitia</span>
                  </div>
          ...
          <div class="pm-right-panel">
            <div class="pm-section-header">
              ...
              <div>
                ...
                <p class="pm-panel-subtitle">Rincian paket edukasi, diskon member & promo</p>
              </div>
            </div>
            ...
            <div class="pm-trip-card">
              <div class="pm-trip-row">
                ...
                <span class="pm-trip-val">Wisata Edukasi</span>
              </div>
              <div class="pm-trip-row">
                <span class="pm-trip-label">Instansi / Sekolah</span>
                <span class="pm-trip-val highlight">{{ bookingData.instansi || '-' }}</span>
              </div>
              <div class="pm-trip-row">
                <span class="pm-trip-label">Tanggal Kegiatan</span>
              ...
              <div v-if="bookingData.isMember" class="pm-member-active-card">
                <div class="pm-member-left">
                  ...
                  <div class="pm-member-info">
                    ...
                    <span class="pm-member-name">{{ bookingData.namaPerwakilan }}</span>
            ...
            <div class="pm-order-items-box">
              <div class="pm-items-header">Rincian Item ({{ totalCartQuantity }} Paket)</div>
            ...
            <div class="pm-order-footer">
              <div class="pm-total-card">
                <div class="pm-total-info">
                  ...
                  <span class="pm-total-sub">Sudah termasuk PPN & fasilitas edukasi</span>
                </div>
    ...
    <div class="ticket-modal-backdrop" v-if="showSuccessModal" @click.self="finishTransaction">
      ...
      <div class="ticket-modal-top-header no-print">
        ...
        <div>
          ...
          <p class="tmt-subtitle">E-Tiket resmi edukasi telah terbit dan siap digunakan oleh rombongan sekolah</p>
        </div>
      </div>
      ...
      <div class="ticket-pass-card" id="printable-ticket-card">
        ...
        <div class="tpc-main">
          ...
          <div class="tpc-title-row">
            <div>
              <h2 class="tpc-heading">E-TIKET WISATA EDUKASI</h2>
          ...
          <div class="tpc-grid-card">
            <div class="tpc-meta-col">
              <span class="tpc-meta-label">Tanggal Pelaksanaan</span>
              <span class="tpc-meta-value highlight">{{ bookingData.tanggal || 'Hari Ini' }}</span>
            </div>
            <div class="tpc-meta-col">
              <span class="tpc-meta-label">Instansi / Sekolah</span>
              <span class="tpc-meta-value">{{ bookingData.instansi || 'Sekolah / Instansi' }}</span>
            </div>
            <div class="tpc-meta-col">
              <span class="tpc-meta-label">Perwakilan / PIC</span>
              <span class="tpc-meta-value">{{ bookingData.namaPerwakilan || 'PIC Edukasi' }}</span>
            </div>
            <div class="tpc-meta-col">
          ...
          <div class="tpc-items-section">
            <span class="tpc-items-heading">Rincian Paket Edukasi ({{ totalCartQuantity }} Pax Peserta):</span>
            <div class="tpc-items-badges">
              <div v-for="item in cart" :key="item.id || item.packageId || item.name" class="tpc-item-pill">
                <span class="tpc-qty-tag">{{ item.qty }} Pax</span>
          ...
          <div class="tpc-gate-notice">
            ...
            <span>Tunjukkan barcode tiket kepada Tour Guide / Trainer di pos registrasi wisata edukasi Kampung Coklat.</span>
          </div>
        </div>
        ...
        <div class="tpc-stub">
          <div class="tpc-stub-header">
            ...
            <span class="tpc-stub-sub">EDUKASI PASS</span>
          </div>
...
.pos-card-full:hover .pos-thumb-wrap-edukasi .pos-thumb-img {
