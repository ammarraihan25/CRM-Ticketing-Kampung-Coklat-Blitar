...
const tipeMemberOptions = [
  { value: '', label: 'Semua Segmen (PR, PP, PT)' },
  { value: 'PR', label: 'PR - Pengunjung Reguler' },
  { value: 'PP', label: 'PP - Jamaah Pengajian' },
  { value: 'PT', label: 'PT - Pengunjung Tour B2B' }
]
          ...
          <table class="report-table">
            ...
            <tbody>
              <tr v-for="m in members" :key="m.id">
                ...
                <td>
                  <span class="plain-type-text">{{ getMemberTypeLabel(m.tipeMember) }}</span>
                </td>
          ...
          <div class="modal-body">
            ...
            <div class="ticket-status-grid" style="grid-template-columns: repeat(2, 1fr); margin-top: 10px;">
              ...
              <div class="ticket-stat-card border-purple">
                ...
                <span class="t-stat-val" style="font-size: 16px;">{{ selectedMember.umur ? selectedMember.umur + ' th' : '-' }} ({{ selectedMember.kategoriUmur || 'Umum' }})</span>
                <span class="t-stat-sub">{{ selectedMember.tanggalLahir ? 'Lahir: ' + selectedMember.tanggalLahir : 'Tgl lahir belum ada' }}</span>
              </div>
