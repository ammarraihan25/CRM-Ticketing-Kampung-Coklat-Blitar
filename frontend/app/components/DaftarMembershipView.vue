...
const filteredMembershipList = computed(() => {
  let list = membershipList.value
  if (selectedAgeCategory.value) {
    list = list.filter(m => m.ageCategory === selectedAgeCategory.value)
  }
            ...
            <div class="detail-section">
              ...
              <div class="data-grid">
                ...
                <div class="data-group">
                  ...
                  <p>{{ selectedApp.birthDate || '-' }}</p>
                </div>
                <div class="data-group">
                  <label>Usia & Kategori</label>
                  <p>{{ selectedApp.age ? selectedApp.age + ' th' : '-' }} <span v-if="selectedApp.ageCategory" class="type-badge" style="margin-left: 6px; font-size: 11px; padding: 2px 8px;">{{ selectedApp.ageCategory }}</span></p>
                </div>
