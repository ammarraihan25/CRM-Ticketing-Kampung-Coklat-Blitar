  ...
  <div class="dashboard-wrapper">
    ...
    <div class="dashboard-header">
      <div class="header-text">
        <h1 class="page-title">Dashboard POS Kasir Tiket</h1>
        <p class="page-subtitle">
          Terhubung secara live dengan server. Shift saat ini: <strong>{{ kasirProfile.shiftDate }}</strong> (Mulai {{ kasirProfile.shiftStart }})
        </p>
      </div>
      <div class="header-actions">
        <NuxtLink to="/pos/tiket-masuk" class="btn-open-terminal" title="Buka antarmuka loket penjualan tiket langsung">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3"><rect x="2" y="3" width="20" height="14" rx="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg>
          <span>Terminal Loket Kasir</span>
        </NuxtLink>
        ...
        <button class="btn-tutup-shift" @click="handleOpenCloseShift">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
