    ...
    <aside class="sidebar-container">
      ...
      <div class="sidebar-nav-section">
        ...
        <div class="nav-group">
          ...
          <NuxtLink to="/crm/non-member" exact-active-class="active" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" class="nav-icon">
            ...
            <span>Pengunjung Non Member</span>
          </NuxtLink>
          <NuxtLink to="/crm/daftar-membership" exact-active-class="active" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" class="nav-icon">
          ...
          <NuxtLink to="/crm/guestbook" exact-active-class="active" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" class="nav-icon">
